...
class Qmess_tontai:
    ...
    def show_window(parent=None):
        """Hiển thị cửa sổ thông báo tài khoản đã tồn tại"""
        ...
        try:
            dk_Qmess_tontai_image = PhotoImage(file=relative_to_assets("Qmess_nho.png"))
            dk_Qmess_tontai_thulai_image = PhotoImage(file=relative_to_assets("Qmess_thulai.png"))
        except Exception:
            return

        # Hiển thị ảnh nền
        canvas.create_image(225.0, 106.0, image=dk_Qmess_tontai_image)
        ...
        # Nút thử lại
        dk_Qmess_datontai_thulai = Button(
            window,
            image=dk_Qmess_tontai_thulai_image,
            borderwidth=0,
            highlightthickness=0,
            command=close_window,
            relief="flat"
        )
        dk_Qmess_datontai_thulai.place(x=151, y=137, width=148, height=34)
