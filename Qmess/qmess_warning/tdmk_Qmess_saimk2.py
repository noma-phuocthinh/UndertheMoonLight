...
class Qmess_tdmk_mk2sai:
    ...
    def show_window(parent=None):
        ...
        try:
            Qmess_tdmk_mk2sai_image = PhotoImage(file=relative_to_assets("Qmess_nho.png"))
            Qmess_tdmk_mk2sai_thulai_image = PhotoImage(file=relative_to_assets("Qmess_thulai.png"))
        except Exception :
            return

        # Hiển thị ảnh nền
        canvas.create_image(225.0, 106.0, image=Qmess_tdmk_mk2sai_image)
        ...
        # Nút thử lại
        Qmess_tdmk_mk2sai_thulai = Button(
            window,
            image=Qmess_tdmk_mk2sai_thulai_image,
            borderwidth=0,
            highlightthickness=0,
            command=close_window,
            relief="flat"
        )
        Qmess_tdmk_mk2sai_thulai.place(x=151.0, y=137.0, width=148.0, height=34.0)
