...
class Qmess_tdmk_thanhcong:
    ...
    def show_window(parent=None, on_close=None):  # Thêm on_close vào tham số
        ...
        try:
            Qmess_tdmk_thanhcong_image = PhotoImage(file=relative_to_assets("Qmess_nho.png"))
            Qmess_tdmk_thanhcong_oker_image = PhotoImage(file=relative_to_assets("Qmess_oker.png"))
        except Exception:
            return

        # Hiển thị ảnh nền
        canvas.create_image(225.0, 106.0, image=Qmess_tdmk_thanhcong_image)
        ...
        # Nút OK
        Qmess_tdmk_thanhcong_oker = Button(
            window,
            image=Qmess_tdmk_thanhcong_oker_image,
            borderwidth=0,
            highlightthickness=0,
            command=close_window,  # Đóng cửa sổ khi bấm nút
            relief="flat"
        )
        Qmess_tdmk_thanhcong_oker.place(x=151.0, y=137.0, width=148.0, height=34.0)
