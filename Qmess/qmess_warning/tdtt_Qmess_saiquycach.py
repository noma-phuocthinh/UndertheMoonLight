...
class Qmess_tdtt_saiquycach:
    ...
    def show_window(parent=None):
        ...
        try:
            Qmess_tdtt_saiquycach_image = PhotoImage(file=relative_to_assets("Qmess_lon.png"))
            Qmess_tdtt_saiquycach_thulai_image= PhotoImage(file=relative_to_assets("Qmess_thulai.png"))
        except Exception:
            return

        # Hiển thị ảnh nền
        canvas.create_image(225.0, 135.0, image=Qmess_tdtt_saiquycach_image)
        ...
        # Nút Thử lại
        Qmess_tdtt_saiquycach_thulai = Button(
            window,
            image=Qmess_tdtt_saiquycach_thulai_image,
            borderwidth=0,
            highlightthickness=0,
            command=close_window,
            relief="flat"
        )
        Qmess_tdtt_saiquycach_thulai.place(x=139.0, y=196.0, width=159.0, height=44.0)
