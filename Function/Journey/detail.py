...
class CustomFrame:
    def __init__(self, parent, data, username, assets_path, user_data_path):
        self.parent = parent
        self.data = data
        ...
        self.user_json_file = self.user_data_path / f"{username}.json"
        self.user_img_path = self.user_data_path / f"{username}_imgs"
